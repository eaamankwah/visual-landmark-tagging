...
def get_data_loaders(
    ...
    # without augmentation). All three resize to 256 then crop to 224,
    # convert to a tensor and normalize using the dataset mean/std.
    data_transforms = {
        "train": transforms.Compose(
            [
                transforms.Resize(256),
                transforms.RandomCrop(224),
                # Data augmentation: random flips, rotation and slight
                # color jitter help the model generalize better and
                # reduce overfitting.
